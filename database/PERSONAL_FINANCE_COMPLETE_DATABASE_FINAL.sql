...
-- Phiên bản: 3.0 - Đã sửa tất cả lỗi
-- =============================================
...
CREATE TABLE RecurringTransactionHistory (
    ...
    FOREIGN KEY (TransactionID) REFERENCES Transactions(TransactionID) ON DELETE NO ACTION
);
...
-- Insert default categories với UserID = NULL
-- Categories Thu nhập
INSERT INTO Categories (UserID, CategoryName, Type, Icon, Color, Description, SortOrder) VALUES
(NULL, N'Lương', 'Income', 'salary', '#27ae60', N'Lương cơ bản hàng tháng', 1),
(NULL, N'Thưởng', 'Income', 'bonus', '#f39c12', N'Thưởng hiệu suất, thưởng lễ tết', 2),
(NULL, N'Phụ cấp', 'Income', 'allowance', '#3498db', N'Phụ cấp xăng xe, ăn trưa, điện thoại', 3),
(NULL, N'Đầu tư', 'Income', 'investment', '#9b59b6', N'Lợi nhuận từ đầu tư, cổ tức', 4),
(NULL, N'Kinh doanh', 'Income', 'business', '#e67e22', N'Thu nhập từ kinh doanh riêng', 5),
(NULL, N'Freelance', 'Income', 'freelance', '#1abc9c', N'Thu nhập từ công việc tự do', 6),
(NULL, N'Thu nhập khác', 'Income', 'other', '#95a5a6', N'Các khoản thu nhập khác', 7);

-- Categories Chi tiêu
INSERT INTO Categories (UserID, CategoryName, Type, Icon, Color, Description, SortOrder) VALUES
(NULL, N'Ăn uống', 'Expense', 'food', '#e74c3c', N'Chi phí ăn uống hàng ngày', 1),
(NULL, N'Đi lại', 'Expense', 'transport', '#3498db', N'Xăng xe, xe bus, taxi, grab', 2),
(NULL, N'Học tập', 'Expense', 'education', '#9b59b6', N'Học phí, sách vở, khóa học', 3),
(NULL, N'Giải trí', 'Expense', 'entertainment', '#f39c12', N'Xem phim, du lịch, game', 4),
(NULL, N'Y tế', 'Expense', 'healthcare', '#e67e22', N'Khám bệnh, thuốc men, bảo hiểm', 5),
(NULL, N'Mua sắm', 'Expense', 'shopping', '#e91e63', N'Quần áo, mỹ phẩm, đồ dùng', 6),
(NULL, N'Hóa đơn', 'Expense', 'bills', '#607d8b', N'Điện, nước, internet, điện thoại', 7),
(NULL, N'Nhà ở', 'Expense', 'housing', '#795548', N'Tiền thuê nhà, sửa chữa', 8),
(NULL, N'Bảo hiểm', 'Expense', 'insurance', '#455a64', N'Bảo hiểm xe, nhà, sức khỏe', 9),
(NULL, N'Tiết kiệm', 'Expense', 'savings', '#4caf50', N'Gửi tiết kiệm, đầu tư', 10),
(NULL, N'Chi tiêu khác', 'Expense', 'other', '#95a5a6', N'Các khoản chi tiêu khác', 11);
